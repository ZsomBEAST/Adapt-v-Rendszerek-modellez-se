...
class RemoteNaiveHunterStrategy:
    ...
    def __init__(self):
        ...
        #tanitandó súlyok
        self.w_dist=1.16010967619254
        self.w_stay=1.793944745352
        self.w_wall = 0.785048888116141
        self.w_neighbor1 = 0.21129702014568
        self.w_neighbor2 = 0.0334155200856935
        self.w_chase = 0.794750216122193
        self.w_escape = 0.0691866676141384
        self.w_stuck = 1.06672238836096
        self.w_tomiddle=0.569039668710419
        #look up table
    ...
    def processObservation(self, fulljson, sendData):
        ...
        if fulljson["type"] == "leaderBoard":
            ...
            sendData(json.dumps({"command": "GameControl", "name": "master",
                                 "payload": {"type": "reset", "data": {"mapPath": ("./maps/" + self.maps[1]), "updateMapPath": ("./maps/" + self.maps[1])}}}))
